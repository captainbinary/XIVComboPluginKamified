...
namespace XIVComboKamifiedPlugin
{
    ...
    public enum CustomComboPreset
    {
        ...
        [OrderedEnum]
        [CustomComboInfo("Lucid Dreaming", "Replace basic attack with lucid dreaming when up. For Healers Only ((for now))", All.JobID, All.Blizzard, All.Dosis, All.Jolt, All.Malefic, All.Stone, All.Ruin)]
        AllLucidDreaming = 9010,
